...
def get_dataset(version: str, molecule: str, train_split: float, val_split: float, test_split: float) -> Tuple[Dataset, ...]:
...
def get_mini_dataloader(version: str, molecule: str, num_items: int, batch_size: int) -> DataLoader:
    ...
    # build mini_dataset out of dataset
    mini_dataset = random_split(dataset, [num_items])
    
    # make loader out of mini_dataset
